...
// ── Mock Data ─────────────────────────────────────────────────
const INIT_AGENCIES = [
  {id:"ag1",name:"وكالة الجزائر المركزية",owner:"أحمد بلقاسم",phone:"0555123456",wilaya:"16",email:"alger.center@driveRENT.dz",status:"active",verified:true,featured:true,plan:"premium",monthlyPrice:8000,subscriptionMonths:12,subscriptionStart:"2025-01-15",subscriptionEnd:"2026-01-15",cars:14,bookings:89,rating:4.8,pendingApproval:false,suspended:false,createdAt:"2025-01-10",messages:[{id:"m1",from:"زبون",text:"هل لديكم سيارات 7 مقاعد؟",time:"09:30",date:"2025-05-18"},{id:"m2",from:"وكالة",text:"نعم لدينا عدة خيارات، تفضل بزيارتنا",time:"09:45",date:"2025-05-18"}]},
  {id:"ag2",name:"تأجير وهران الغرب",owner:"فاطمة زروقي",phone:"0661987654",wilaya:"31",email:"oran.west@driveRENT.dz",status:"active",verified:true,featured:false,plan:"standard",monthlyPrice:5000,subscriptionMonths:6,subscriptionStart:"2025-03-01",subscriptionEnd:"2025-09-01",cars:8,bookings:45,rating:4.5,pendingApproval:false,suspended:false,createdAt:"2025-03-01",messages:[{id:"m3",from:"زبون",text:"ما هو سعر الكيا سبورتاج؟",time:"14:00",date:"2025-05-19"},{id:"m4",from:"وكالة",text:"السعر 4500 دج في اليوم",time:"14:10",date:"2025-05-19"}]},
  {id:"ag3",name:"سيارات قسنطينة الشرق",owner:"محمد مختاري",phone:"0770456123",wilaya:"25",email:"const.east@driveRENT.dz",status:"pending",verified:false,featured:false,plan:"basic",monthlyPrice:3500,subscriptionMonths:0,subscriptionStart:null,subscriptionEnd:null,cars:5,bookings:0,rating:0,pendingApproval:true,renewalRequest:false,suspended:false,createdAt:"2025-05-18",messages:[]},
  {id:"ag4",name:"رينتكار باتنة",owner:"نور الدين عيساوي",phone:"0550789012",wilaya:"05",email:"batna.rent@driveRENT.dz",status:"active",verified:true,featured:false,plan:"standard",monthlyPrice:5000,subscriptionMonths:3,subscriptionStart:"2025-02-20",subscriptionEnd:"2025-05-20",cars:6,bookings:32,rating:4.2,pendingApproval:false,renewalRequest:true,renewalMonths:6,renewalRequestDate:"2025-05-19",suspended:false,createdAt:"2025-02-15",messages:[{id:"m5",from:"زبون",text:"أريد حجز سيارة لأسبوع",time:"11:00",date:"2025-05-17"}]},
  {id:"ag5",name:"وكالة سطيف النجوم",owner:"ليلى بن عيسى",phone:"0661334455",wilaya:"19",email:"setif.star@driveRENT.dz",status:"pending",verified:false,featured:false,plan:"basic",monthlyPrice:3500,subscriptionMonths:0,subscriptionStart:null,subscriptionEnd:null,cars:3,bookings:0,rating:0,pendingApproval:true,renewalRequest:false,suspended:false,createdAt:"2025-05-20",messages:[]},
  {id:"ag6",name:"تأجير عنابة الفاخرة",owner:"كريم حمداوي",phone:"0555667788",wilaya:"23",email:"annaba.lux@driveRENT.dz",status:"active",verified:true,featured:false,plan:"premium",monthlyPrice:8000,subscriptionMonths:12,subscriptionStart:"2024-06-01",subscriptionEnd:"2025-06-01",cars:10,bookings:67,rating:3.9,pendingApproval:false,renewalRequest:true,renewalMonths:12,renewalRequestDate:"2025-05-20",suspended:false,createdAt:"2024-05-28",messages:[]},
  {id:"ag7",name:"بلقائد للتأجير - تيزي",owner:"يوسف أيت علي",phone:"0770112233",wilaya:"15",email:"tizi.rent@driveRENT.dz",status:"active",verified:true,featured:true,plan:"premium",monthlyPrice:8000,subscriptionMonths:8,subscriptionStart:"2025-01-01",subscriptionEnd:"2025-09-01",cars:12,bookings:74,rating:4.7,pendingApproval:false,renewalRequest:false,suspended:false,createdAt:"2024-12-20",messages:[{id:"m6",from:"زبون",text:"هل يمكن التوصيل للمطار؟",time:"16:30",date:"2025-05-20"},{id:"m7",from:"وكالة",text:"نعم نوفر خدمة التوصيل مقابل 1000 دج إضافية",time:"16:45",date:"2025-05-20"}]},
  {id:"ag8",name:"وكالة بجاية للسياحة",owner:"سمير بومعزة",phone:"0662445566",wilaya:"06",email:"bejaia.tour@driveRENT.dz",status:"pending",verified:false,featured:false,plan:"standard",monthlyPrice:5000,subscriptionMonths:0,subscriptionStart:null,subscriptionEnd:null,cars:0,bookings:0,rating:0,pendingApproval:true,renewalRequest:false,suspended:false,createdAt:"2025-05-21",messages:[]},
];

const INIT_CARS = [
  {id:"c1",agencyId:"ag1",brand:"Toyota",model:"Camry",year:2023,price:4500,type:"sedan",isNew:true,plateNum:"16-123-AG",available:true,bookings:12,addedDate:"2025-05-15"},
  {id:"c2",agencyId:"ag1",brand:"Hyundai",model:"Tucson",year:2024,price:5500,type:"suv",isNew:true,plateNum:"16-456-AG",available:true,bookings:8,addedDate:"2025-05-18"},
  {id:"c3",agencyId:"ag2",brand:"Kia",model:"Sportage",year:2023,price:4500,type:"suv",isNew:false,plateNum:"31-789-OA",available:false,bookings:15,addedDate:"2025-03-10"},
  {id:"c4",agencyId:"ag7",brand:"Mercedes",model:"E200",year:2024,price:9000,type:"luxury",isNew:true,plateNum:"15-321-KA",available:true,bookings:5,addedDate:"2025-05-19"},
  {id:"c5",agencyId:"ag4",brand:"Renault",model:"Clio 5",year:2022,price:3200,type:"sedan",isNew:false,plateNum:"05-654-BA",available:true,bookings:20,addedDate:"2025-02-25"},
  {id:"c6",agencyId:"ag1",brand:"Volkswagen",model:"Golf",year:2023,price:4200,type:"sedan",isNew:false,plateNum:"16-987-AG",available:true,bookings:18,addedDate:"2025-01-20"},
];

const INIT_BOOKINGS = [
  {id:"bk1",carId:"c1",agencyId:"ag1",customer:"رشيد بوعلام",phone:"0551234567",wilaya:"16",from:"2025-05-20",to:"2025-05-23",price:13500,status:"confirmed",createdAt:"2025-05-18"},
  {id:"bk2",carId:"c3",agencyId:"ag2",customer:"سمير حمادي",phone:"0662345678",wilaya:"31",from:"2025-05-21",to:"2025-05-25",price:18000,status:"pending",createdAt:"2025-05-19"},
  {id:"bk3",carId:"c4",agencyId:"ag7",customer:"نادية بلال",phone:"0770345678",wilaya:"15",from:"2025-05-22",to:"2025-05-24",price:18000,status:"confirmed",createdAt:"2025-05-19"},
  {id:"bk4",carId:"c5",agencyId:"ag4",customer:"حسين قاسمي",phone:"0553456789",wilaya:"05",from:"2025-05-19",to:"2025-05-21",price:6400,status:"completed",createdAt:"2025-05-17"},
  {id:"bk5",carId:"c6",agencyId:"ag1",customer:"زينب مسعود",phone:"0664567890",wilaya:"16",from:"2025-05-25",to:"2025-05-30",price:21000,status:"pending",createdAt:"2025-05-20"},
  {id:"bk6",carId:"c2",agencyId:"ag1",customer:"عمر شريف",phone:"0775678901",wilaya:"09",from:"2025-05-23",to:"2025-05-27",price:22000,status:"confirmed",createdAt:"2025-05-20"},
];

const INIT_REVIEWS = [
  {id:"r1",agencyId:"ag1",customer:"أمين بوكرة",rating:5,text:"خدمة ممتازة والسيارة نظيفة جداً، سأعود بالتأكيد",status:"pending",createdAt:"2025-05-19"},
  {id:"r2",agencyId:"ag7",customer:"سارة عيسى",rating:4,text:"تجربة جيدة بشكل عام، فقط تأخير بسيط في التسليم",status:"pending",createdAt:"2025-05-20"},
  {id:"r3",agencyId:"ag2",customer:"محمد طاهر",rating:3,text:"السيارة معقولة لكن الأسعار مرتفعة نسبياً",status:"approved",createdAt:"2025-05-18"},
  {id:"r4",agencyId:"ag4",customer:"فريدة حمدي",rating:5,text:"أحسن وكالة في باتنة، شكراً جزيلاً",status:"approved",createdAt:"2025-05-17"},
  {id:"r5",agencyId:"ag6",customer:"رياض بن علي",rating:1,text:"تجربة سيئة جداً، السيارة كانت بها مشاكل ميكانيكية خطيرة",status:"pending",createdAt:"2025-05-20"},
];

// Admin accounts with roles
const ADMIN_ACCOUNTS = [
  {id:"adm1",name:"المدير العام",username:"superadmin",password:"Admin@2025",role:"superadmin",avatar:"م",permissions:["all"],active:true,createdAt:"2024-01-01"},
  {id:"adm2",name:"مشرف الوكالات",username:"agencies_mod",password:"Mod@123",role:"agencies",avatar:"و",permissions:["agencies","cars","bookings"],active:true,createdAt:"2025-01-15"},
  {id:"adm3",name:"مشرف الرسائل",username:"messages_mod",password:"Msg@123",role:"messages",avatar:"ر",permissions:["messages"],active:true,createdAt:"2025-02-01"},
  {id:"adm4",name:"مشرف التعليقات",username:"reviews_mod",password:"Rev@123",role:"reviews",avatar:"ت",permissions:["reviews"],active:false,createdAt:"2025-03-10"},
];
...
export default function AdminPanel() {
  ...
  const [notifications, setNotifications] = useState([
    {id:"n1",type:"warning",msg:"اشتراك وكالة باتنة ينتهي خلال يومين",agencyId:"ag4",time:"منذ ساعة",read:false},
    {id:"n2",type:"new",msg:"وكالة جديدة تنتظر الموافقة: وكالة سطيف النجوم",agencyId:"ag5",time:"منذ 10 دقائق",read:false},
    {id:"n3",type:"new",msg:"وكالة جديدة تنتظر الموافقة: سيارات قسنطينة الشرق",agencyId:"ag3",time:"منذ يومين",read:false},
    {id:"n4",type:"review",msg:"تعليق جديد ينتظر المراجعة",time:"منذ ساعتين",read:true},
  ]);
  ...
  function handleLogin() {
    const acc = ADMIN_ACCOUNTS.find(a=>a.username===loginForm.username && a.password===loginForm.password && a.active);
    if(acc) { setAuth(acc); setPage("dashboard"); setLoginErr(""); }
  ...
  return (
    <div dir="rtl" style={{minHeight:"100vh",background:S.bg,color:S.text,display:"flex",flexDirection:"column"}}>
      ...
      <header style={{height:60,background:"rgba(10,10,18,.95)",backdropFilter:"blur(12px)",borderBottom:`1px solid ${S.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 20px",position:"sticky",top:0,zIndex:100,gap:16}}>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            ...
            <span style={{fontWeight:900,fontSize:16,color:"#fff"}}>DriveRENT <span style={{color:S.purpleBright,fontSize:13,fontWeight:700}}>Admin</span></span>
          </div>
        </div>
      ...
      <div style={{display:"flex",flex:1}}>
        {/* Sidebar */}
        <aside style={{width:sidebarOpen?S.sidebar:0,minWidth:sidebarOpen?S.sidebar:0,background:"rgba(10,10,18,.8)",borderLeft:`1px solid ${S.border}`,transition:"all .25s",overflow:"hidden",position:"sticky",top:60,height:"calc(100vh - 60px)"}}>
          <nav style={{padding:"16px 12px",display:"flex",flexDirection:"column",gap:4}}>
            {navItems.filter(n=>n.perm==="all"||canAccess(n.perm)||auth.role==="superadmin").map(item=>(
              <button key={item.key} onClick={()=>setPage(item.key)}
                style={{background:page===item.key?S.purpleLight:"none",border:`1px solid ${page===item.key?S.purple+"44":"transparent"}`,color:page===item.key?"#fff":S.textMuted,borderRadius:10,padding:"10px 12px",cursor:"pointer",display:"flex",alignItems:"center",gap:10,width:"100%",textAlign:"right",fontSize:13,fontWeight:page===item.key?700:400,transition:"all .2s",position:"relative"}}
        ...
        {/* Main Content */}
        <main style={{flex:1,padding:"24px",overflowY:"auto",maxHeight:"calc(100vh - 60px)"}}>
          ...
          {page==="admins" && auth.role==="superadmin" && <AdminsPage admins={admins} setAdmins={setAdmins} />}
    ...
    <div dir="rtl" style={{minHeight:"100vh",background:S.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
      ...
      <div style={{width:"100%",maxWidth:420,animation:"fadeIn .4s ease"}}>
        <div style={{textAlign:"center",marginBottom:32}}>
          ...
          <div style={{fontSize:13,color:S.textMuted}}>DriveRENT — منصة الإدارة المركزية</div>
        </div>
        <div style={{background:S.bgCard,border:`1px solid ${S.border}`,borderRadius:20,padding:"32px 28px"}}>
          ...
          <div style={{marginTop:24,padding:16,background:"rgba(124,58,237,.06)",border:`1px solid rgba(124,58,237,.12)`,borderRadius:12}}>
            <div style={{fontSize:10,color:S.textDim,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>حسابات تجريبية</div>
            {ADMIN_ACCOUNTS.map(a=>(
              <div key={a.id} onClick={()=>setForm({username:a.username,password:a.password})} style={{display:"flex",justifyContent:"space-between",padding:"6px 0",borderBottom:`1px solid ${S.border}`,cursor:"pointer",fontSize:11}}>
                <span style={{color:"rgba(255,255,255,.6)",fontFamily:"monospace"}}>{a.username}</span>
                <span style={{color:ROLES[a.role]?.color,fontSize:10}}>{ROLES[a.role]?.label}</span>
              </div>
            ))}
          </div>
        </div>
        <div style={{textAlign:"center",marginTop:16,fontSize:10,color:S.textDim}}>© 2025 DriveRENT — لوحة الإدارة</div>
      </div>
    </div>
  );
}
...
function AddAgencyModal({onClose,setAgencies}) {
  ...
  function handleAdd() {
    const now = new Date();
    const end = new Date(now);
    end.setMonth(end.getMonth()+form.subscriptionMonths);
    setAgencies(p=>[...p,{
      id:"ag"+(Date.now()),name:form.name,owner:form.owner,phone:form.phone,email:form.email,
      wilaya:form.wilaya,status:"active",verified:false,featured:false,plan:form.plan,
      monthlyPrice:parseInt(form.monthlyPrice),subscriptionMonths:parseInt(form.subscriptionMonths),
      subscriptionStart:now.toISOString().split("T")[0],subscriptionEnd:end.toISOString().split("T")[0],
      cars:0,bookings:0,rating:0,pendingApproval:false,suspended:false,createdAt:now.toISOString().split("T")[0],messages:[]
    }]);
    onClose();
  }
...
function PricingPage({agencies,onAction}) {
  const PLAN_DEFAULTS = {
    basic:{price:3500,label:"أساسية",icon:"🔵",color:S.blue,desc:"حتى 5 سيارات، دعم عادي، ظهور عادي",features:["5 سيارات كحد أقصى","دعم عادي","ظهور عادي في المنصة","بدون تمييز"]},
    standard:{price:5000,label:"قياسية",icon:"🟣",color:S.purple,desc:"حتى 15 سيارة، أولوية في الدعم، إمكانية التمييز",features:["15 سيارة كحد أقصى","دعم ذو أولوية","ظهور متقدم في المنصة","إمكانية التمييز"]},
    premium:{price:8000,label:"مميزة",icon:"⭐",color:"#F59E0B",desc:"سيارات غير محدودة، دعم 24/7، تمييز تلقائي",features:["سيارات غير محدودة","دعم 24/7","تمييز تلقائي","الظهور في شريط السلايدر"]},
  };

  const [plans,setPlans] = useState(()=>Object.fromEntries(Object.entries(PLAN_DEFAULTS).map(([k,v])=>[k,{...v}])));
  const [editingPlan,setEditingPlan] = useState(null); // null | "basic"|"standard"|"premium"
  const [editBuf,setEditBuf] = useState({});
  const [editFeatureIdx,setEditFeatureIdx] = useState(null);
  const [saved,setSaved] = useState("");

  const showSaved = (msg) => { setSaved(msg); setTimeout(()=>setSaved(""),2800); };

  const startEdit = (key) => {
    setEditBuf({...plans[key], featuresBuf:[...plans[key].features]});
    setEditingPlan(key);
    setEditFeatureIdx(null);
  };

  const saveEdit = (key) => {
    const updated = {...plans[key], price:parseInt(editBuf.price)||plans[key].price, desc:editBuf.desc, label:editBuf.label, features:editBuf.featuresBuf};
    setPlans(p=>({...p,[key]:updated}));
    // apply price to all agencies in this plan
    agencies.filter(a=>a.plan===key).forEach(ag=>onAction(ag.id,"setPrice",updated.price));
    setEditingPlan(null);
    showSaved(`✅ تم حفظ بيانات باقة ${updated.label} وتطبيق السعر على الوكالات`);
  };

  const applyToAll = (key) => {
    agencies.filter(a=>a.plan===key).forEach(ag=>onAction(ag.id,"setPrice",plans[key].price));
    showSaved(`✅ تم تطبيق السعر ${plans[key].price.toLocaleString()} دج على ${agencies.filter(a=>a.plan===key).length} وكالة`);
  };
  ...
  return (
    <div style={{animation:"fadeIn .3s ease"}}>
      <div style={{marginBottom:22}}>
        ...
        <p style={{fontSize:12,color:S.textMuted,margin:0}}>تعديل بيانات الباقات وأسعارها وتطبيقها على الوكالات</p>
      </div>

      {saved&&(
        <div style={{background:"rgba(16,185,129,.1)",border:"1px solid rgba(16,185,129,.25)",borderRadius:10,padding:"11px 16px",marginBottom:18,fontSize:13,color:S.green,display:"flex",alignItems:"center",gap:8}}>
          <I.Check/> {saved}
        </div>
      )}
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(310px,1fr))",gap:16,marginBottom:28}}>
        {Object.entries(plans).map(([key,info])=>{
          const agCount = agencies.filter(a=>a.plan===key).length;
          const isEditing = editingPlan===key;
          return (
            <div key={key} style={{background:S.bgCard,border:`1px solid ${info.color}33`,borderRadius:18,padding:22,transition:"border-color .2s"}}
              onMouseEnter={e=>{ if(!isEditing) e.currentTarget.style.borderColor=info.color+"66"; }}
              onMouseLeave={e=>{ if(!isEditing) e.currentTarget.style.borderColor=info.color+"33"; }}>

              {/* Header */}
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  <div style={{width:44,height:44,borderRadius:12,background:info.color+"18",border:`1px solid ${info.color}33`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:20}}>{info.icon}</div>
                  <div>
                    {isEditing?(
                      <input value={editBuf.label} onChange={e=>setEditBuf(p=>({...p,label:e.target.value}))}
                        style={{background:"rgba(255,255,255,.08)",border:`1px solid ${info.color}66`,borderRadius:7,color:"#fff",padding:"4px 8px",fontSize:14,fontWeight:800,width:100}}/>
                    ):(
                      <div style={{fontSize:15,fontWeight:800,color:"#fff"}}>باقة {info.label}</div>
                    )}
                    <div style={{fontSize:11,color:S.textMuted}}>{agCount} وكالة مشتركة</div>
                  </div>
                </div>
                {!isEditing?(
                  <button onClick={()=>startEdit(key)}
                    style={{background:"rgba(255,255,255,.06)",border:`1px solid ${S.border}`,color:S.textMuted,borderRadius:8,padding:"6px 10px",cursor:"pointer",fontSize:11,display:"flex",alignItems:"center",gap:4}}>
                    <I.Edit/> تعديل
                  </button>
                ):(
                  <div style={{display:"flex",gap:5}}>
                    <button onClick={()=>saveEdit(key)} style={{background:S.green+"22",border:`1px solid ${S.green}44`,color:S.green,borderRadius:7,padding:"5px 10px",cursor:"pointer",fontSize:11,fontWeight:700}}>✓ حفظ</button>
              ...
              {isEditing?(
                <div style={{marginBottom:14}}>
                  <div style={{fontSize:10,color:S.textDim,marginBottom:5,fontWeight:700}}>وصف الباقة</div>
                ...
                <div style={{fontSize:11,color:S.textMuted,marginBottom:14,lineHeight:1.5}}>{info.desc}</div>
              )}
              ...
              <div style={{marginBottom:16}}>
                <div style={{fontSize:10,color:S.textDim,fontWeight:700,marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                  مزايا الباقة
                  {isEditing&&<button onClick={()=>setEditBuf(p=>({...p,featuresBuf:[...p.featuresBuf,"ميزة جديدة"]}))} style={{background:info.color+"20",border:"none",color:info.color,borderRadius:5,padding:"2px 7px",cursor:"pointer",fontSize:10}}>+ إضافة</button>}
                </div>
                {(isEditing?editBuf.featuresBuf:info.features).map((f,i)=>(
                  <div key={i} style={{display:"flex",alignItems:"center",gap:7,marginBottom:6}}>
                    <div style={{width:5,height:5,borderRadius:"50%",background:info.color,flexShrink:0}}/>
                    {isEditing&&editFeatureIdx===i?(
                      <div style={{display:"flex",flex:1,gap:4}}>
                        <input value={editBuf.featuresBuf[i]} onChange={e=>setEditBuf(p=>({...p,featuresBuf:p.featuresBuf.map((x,j)=>j===i?e.target.value:x)}))}
                          autoFocus
                          style={{flex:1,background:"rgba(255,255,255,.08)",border:`1px solid ${info.color}66`,borderRadius:6,color:"#fff",padding:"3px 7px",fontSize:11}}/>
                        <button onClick={()=>setEditFeatureIdx(null)} style={{background:"none",border:"none",color:S.green,cursor:"pointer",fontSize:13}}>✓</button>
                        <button onClick={()=>{setEditBuf(p=>({...p,featuresBuf:p.featuresBuf.filter((_,j)=>j!==i)}));setEditFeatureIdx(null)}} style={{background:"none",border:"none",color:S.red,cursor:"pointer",fontSize:13}}>✕</button>
                      </div>
                    ):(
                      <span onClick={()=>isEditing&&setEditFeatureIdx(i)} style={{fontSize:12,color:"rgba(255,255,255,.65)",flex:1,cursor:isEditing?"pointer":"default",padding:isEditing?"2px 5px":"0",borderRadius:4,background:isEditing?"rgba(255,255,255,.04)":"none"}}>{f}</span>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div style={{background:"rgba(255,255,255,.04)",borderRadius:12,padding:"14px 16px",marginBottom:14}}>
                <div style={{fontSize:11,color:S.textDim,marginBottom:6}}>السعر الشهري</div>
                {isEditing?(
                  <div style={{display:"flex",gap:8,alignItems:"center"}}>
                    <input type="number" value={editBuf.price} onChange={e=>setEditBuf(p=>({...p,price:e.target.value}))}
                    ...
                    <span style={{fontSize:12,color:S.textDim}}>دج/شهر</span>
                  </div>
                ):(
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                    ...
                    <button onClick={()=>applyToAll(key)}
                      style={{background:`linear-gradient(135deg,${info.color}33,${info.color}18)`,border:`1px solid ${info.color}44`,color:info.color,borderRadius:8,padding:"6px 12px",cursor:"pointer",fontSize:11,fontWeight:700}}>
                      🔄 تطبيق على الكل
                    </button>
                  </div>
                )}
              ...
              <div style={{display:"flex",gap:8}}>
                <div style={{flex:1,background:"rgba(255,255,255,.03)",borderRadius:9,padding:"8px 12px",textAlign:"center"}}>
                  <div style={{fontSize:9,color:S.textDim,marginBottom:2}}>عدد الوكالات</div>
                ...
                <div style={{flex:1,background:"rgba(255,255,255,.03)",borderRadius:9,padding:"8px 12px",textAlign:"center"}}>
                  ...
                  <div style={{fontSize:13,fontWeight:900,color:info.color}}>{(info.price*agCount).toLocaleString()} دج</div>
                </div>
              </div>
            </div>
          );
      ...
      {/* Per-agency pricing table with plan change */}
      <div>
        <div style={{fontSize:14,fontWeight:800,color:"#fff",marginBottom:14}}>💼 اشتراكات الوكالات الفردية — تعديل الباقة والسعر</div>
        <div style={{background:S.bgCard,border:`1px solid ${S.border}`,borderRadius:16,overflow:"hidden"}}>
          <table style={{width:"100%",borderCollapse:"collapse"}}>
            <thead>
              <tr style={{background:"rgba(255,255,255,.04)"}}>
                {["الوكالة","الولاية","الباقة الحالية","السعر الشهري","تاريخ الانتهاء","تغيير الباقة","إجراء"].map(h=>(
            ...
            <tbody>
              {agencies.filter(a=>!a.pendingApproval&&a.status!=="rejected").map(ag=>(
                <AgencyPriceRow key={ag.id} ag={ag} onAction={onAction} plans={plans}/>
              ))}
            </tbody>
          </table>
        </div>
...
function AgencyPriceRow({ag,onAction,plans}) {
  ...
  const info = plans[ag.plan]||plans.basic;
  const d = daysLeft(ag.subscriptionEnd);
  const dayColor = d<=0&&ag.subscriptionEnd?S.red:d<=7?S.amber:S.green;

  const applyPlanChange = () => {
    const planData = plans[newPlan]||plans.basic;
    onAction(ag.id,"setPlan",newPlan);
    onAction(ag.id,"setPrice",planData.price);
  ...
  return (
    <tr style={{borderBottom:`1px solid ${S.border}`}}
      ...
      <td style={{padding:"11px 14px"}}><span style={{fontSize:12,color:S.textMuted}}>{getWilaya(ag.wilaya)}</span></td>
      <td style={{padding:"11px 14px"}}>
        <span style={{background:info.color+"18",color:info.color,borderRadius:6,padding:"2px 10px",fontSize:11,fontWeight:700}}>
        ...
        {editing?(
          <div style={{display:"flex",gap:5,alignItems:"center"}}>
            <input type="number" value={price} onChange={e=>setPrice(e.target.value)}
              style={{width:90,background:"rgba(255,255,255,.08)",border:`1px solid ${S.purple}`,borderRadius:7,color:"#fff",padding:"5px 9px",fontSize:13}}/>
            <button onClick={()=>{onAction(ag.id,"setPrice",parseInt(price));setEditing(false)}}
              style={{background:S.green+"22",border:"none",color:S.green,borderRadius:6,padding:"5px 7px",cursor:"pointer"}}><I.Check/></button>
            <button onClick={()=>{setPrice(ag.monthlyPrice);setEditing(false)}}
              style={{background:"rgba(239,68,68,.15)",border:"none",color:S.red,borderRadius:6,padding:"5px 7px",cursor:"pointer"}}><I.X/></button>
          </div>
        ):(
          <span style={{fontSize:13,fontWeight:700,color:"#fff"}}>{ag.monthlyPrice.toLocaleString()} دج</span>
        )}
      </td>
      <td style={{padding:"11px 14px"}}>
        {ag.subscriptionEnd?(
          <div>
            <span style={{fontSize:12,fontWeight:700,color:dayColor}}>{d<=0?"منتهي":`${d} يوم`}</span>
        ...
        {changingPlan?(
          <div style={{display:"flex",gap:4,flexWrap:"wrap",alignItems:"center"}}>
            <select value={newPlan} onChange={e=>{setNewPlan(e.target.value);}}
              style={{background:"rgba(255,255,255,.08)",border:`1px solid ${S.purple}`,borderRadius:7,color:"#fff",padding:"4px 7px",fontSize:11}}>
              {Object.entries(plans).map(([k,p])=><option key={k} value={k}>{p.icon} {p.label}</option>)}
            </select>
            <select value={newMonths} onChange={e=>setNewMonths(parseInt(e.target.value))}
              style={{background:"rgba(255,255,255,.08)",border:`1px solid ${S.purple}`,borderRadius:7,color:"#fff",padding:"4px 6px",fontSize:11,width:55}}>
              {[1,2,3,6,12].map(m=><option key={m} value={m}>{m}ش</option>)}
            </select>
            <button onClick={applyPlanChange} style={{background:S.green+"22",border:`1px solid ${S.green}44`,color:S.green,borderRadius:6,padding:"4px 8px",cursor:"pointer",fontSize:11,fontWeight:700}}>✓ تطبيق</button>
          ...
          <button onClick={()=>{setNewPlan(ag.plan);setNewMonths(ag.subscriptionMonths||1);setChangingPlan(true);}}
            style={{background:"rgba(124,58,237,.1)",border:`1px solid rgba(124,58,237,.25)`,color:S.purpleBright,borderRadius:7,padding:"5px 10px",cursor:"pointer",fontSize:11,fontWeight:700,display:"flex",alignItems:"center",gap:4}}>
            <I.Edit/> تغيير الباقة
          </button>
        )}
      </td>
      <td style={{padding:"11px 14px"}}>
        <button onClick={()=>setEditing(true)} disabled={editing}
          style={{background:"rgba(255,255,255,.06)",border:`1px solid ${S.border}`,color:S.textMuted,borderRadius:7,padding:"5px 9px",cursor:"pointer",fontSize:11,display:"flex",alignItems:"center",gap:4}}>
          <I.Edit/> السعر
        </button>
      </td>
    </tr>
...
// ══════════════════════════════════════════════════════════════
function AdminsPage({admins,setAdmins}) {
  ...
  function handleAdd() {
    ...
    setAdmins(p=>[...p,{
      id:"adm"+(Date.now()),name:newAdmin.name,username:newAdmin.username,password:newAdmin.password,
      role:newAdmin.role,avatar:newAdmin.name[0],permissions:newAdmin.role==="superadmin"?["all"]:[newAdmin.role],
      active:true,createdAt:new Date().toISOString().split("T")[0]
    }]);
    setShowAdd(false);
    setNewAdmin({name:"",username:"",password:"",role:"messages"});
  }
